...
- **时间、等待、网络、全局状态、隔离或 determinism baseline 测试：** M2 对应 owner 迁移前继续读 `docs/architecture/backend-test-determinism.md`。
- **验证：** 从受影响 solution/project、测试 Governance 和上述 producer 取得命令；只报告实际执行的 lane。
