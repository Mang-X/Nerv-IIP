---
applyTo: "src/Nerv.IIP.Business.Erp.Web/Endpoints/**/*.cs"
---
...
- 类文件应放置在 `src/Nerv.IIP.Business.Erp.Web/Endpoints/{Module}/` 目录下。
- 端点文件名格式为 `{Action}{Entity}Endpoint.cs`。
- 请求 DTO、响应 DTO 与端点定义在同一文件中。

## 代码示例

**文件**: `src/Nerv.IIP.Business.Erp.Web/Endpoints/User/CreateUserEndpoint.cs`
...
namespace Nerv.IIP.Business.Erp.Web.Endpoints.User;
