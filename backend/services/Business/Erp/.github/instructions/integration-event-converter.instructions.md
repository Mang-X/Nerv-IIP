---
applyTo: "src/Nerv.IIP.Business.Erp.Web/Application/IntegrationEventConverters/*.cs"
---
...
- 转换器应放置在 `src/Nerv.IIP.Business.Erp.Web/Application/IntegrationEventConverters/` 目录下。
- 转换器文件名格式为 `{Entity}{Action}IntegrationEventConverter.cs`。

## 代码示例

**文件**: `src/Nerv.IIP.Business.Erp.Web/Application/IntegrationEventConverters/UserCreatedIntegrationEventConverter.cs`
