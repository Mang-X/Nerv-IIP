---
applyTo: "src/Nerv.IIP.Business.Erp.Web/Application/DomainEventHandlers/*.cs"
---
...
- 类文件应放置在 `src/Nerv.IIP.Business.Erp.Web/Application/DomainEventHandlers/` 目录下。
...
using Nerv.IIP.Business.Erp.Web.Domain.DomainEvents;
