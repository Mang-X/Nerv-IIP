---
applyTo: "src/Nerv.IIP.Business.Erp.Infrastructure/EntityConfigurations/*.cs"
---
...
- 类文件应放置在 `src/Nerv.IIP.Business.Erp.Infrastructure/EntityConfigurations/` 目录下。
- 文件名格式为 `{EntityName}EntityTypeConfiguration.cs`。

## 代码示例

**文件**: `src/Nerv.IIP.Business.Erp.Infrastructure/EntityConfigurations/UserEntityTypeConfiguration.cs`
