---
applyTo: "src/Nerv.IIP.Business.Erp.Domain/DomainEvents/*.cs"
---
...
- 类文件应放置在 `src/Nerv.IIP.Business.Erp.Domain/DomainEvents` 目录下。
- 为每个聚合添加一个领域事件文件。
...
**文件**: `src/Nerv.IIP.Business.Erp.Domain/DomainEvents/UserDomainEvents.cs`

```csharp
using Nerv.IIP.Business.Erp.Domain.Aggregates.UserAggregate;
