...
- 领域层测试：`test/Nerv.IIP.Business.Erp.Domain.Tests/{EntityName}Tests.cs`。
- Web 层测试：`test/Nerv.IIP.Business.Erp.Web.Tests/{Feature}Tests.cs`。
- 基础设施层测试：`test/Nerv.IIP.Business.Erp.Infrastructure.Tests/{Component}Tests.cs`。
