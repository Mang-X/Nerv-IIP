        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_wc_machine_overhead_reconciliations_downtime", "abnormal_downtime_hours = round(abnormal_downtime_ticks / 36000000000.0, 12) AND ((abnormal_downtime_ticks = 0 AND abnormal_downtime_disposition = 'None') OR (abnormal_downtime_ticks > 0 AND abnormal_downtime_disposition IN ('Pending', 'PeriodExpense')))");
                    table.ForeignKey(
