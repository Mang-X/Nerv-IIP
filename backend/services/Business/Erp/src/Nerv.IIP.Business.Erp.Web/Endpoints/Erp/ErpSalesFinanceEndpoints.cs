...
public static class ErpFinanceEndpointContracts
{
    ...
    [
        ...
        new(typeof(ReconcileWorkCenterMachineOverheadEndpoint), "POST", "/api/business/v1/erp/finance/work-center-machine-overhead-reconciliations", ErpPermissionCodes.FinanceManage, InternalServiceAuthorizationPolicy.Name, "reconcileErpWorkCenterMachineOverhead"),
        new(typeof(ListWorkCenterMachineOverheadReconciliationsEndpoint), "GET", "/api/business/v1/erp/finance/work-center-machine-overhead-reconciliations", ErpPermissionCodes.FinanceRead, InternalServiceAuthorizationPolicy.Name, "listErpWorkCenterMachineOverheadReconciliations"),
