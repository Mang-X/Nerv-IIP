...
public static class ApprovalPersistenceServiceCollectionExtensions
{
    public static IServiceCollection AddApprovalPostgreSqlPersistence(
        ...
        bool enableSensitiveDataLogging = false)
    {
        ...
        services.AddDbContext<ApplicationDbContext>(options =>
        {
            options.UseNpgsql(
                connectionString,
                npgsql => npgsql.MigrationsHistoryTable("__EFMigrationsHistory", ApprovalFacts.Schema));
