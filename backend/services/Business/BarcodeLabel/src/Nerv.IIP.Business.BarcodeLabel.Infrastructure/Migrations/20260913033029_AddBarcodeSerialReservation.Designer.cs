...
namespace Nerv.IIP.Business.BarcodeLabel.Infrastructure.Migrations
{
    ...
    [Migration("20260913033029_AddBarcodeSerialReservation")]
    partial class AddBarcodeSerialReservation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Nerv.IIP.Business.BarcodeLabel.Domain.AggregatesModel.LabelPrintBatchAggregate.LabelPrintBatch", b =>
                {
                    ...
                    b.Property<string>("ProductionReportId")
                        ...
                        .HasComment("Nullable MES production report id associated by activation.");

                    b.Property<string>("ProductionReportNo")
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)")
                        .HasColumnName("production_report_no")
                        .HasComment("Nullable MES production report number associated by activation.");
            ...
            modelBuilder.Entity("Nerv.IIP.Business.BarcodeLabel.Domain.AggregatesModel.LabelPrintBatchAggregate.LabelPrintItem", b =>
                {
                    ...
                    b.Property<string>("EnvironmentId")
                        ...
                        .HasColumnType("character varying(100)")
                        .HasColumnName("environment_id")
                        .HasComment("Environment id owning the generated serial.");
                    ...
                    b.Property<string>("OrganizationId")
                        ...
                        .HasColumnType("character varying(100)")
                        .HasColumnName("organization_id")
                        .HasComment("Organization tenant id owning the generated serial.");
                    ...
                    b.Property<string>("SerialNumber")
                        ...
                        .HasComment("BarcodeLabel allocated serialized unit identifier encoded in this label.");
            ...
            modelBuilder.Entity("Nerv.IIP.Business.BarcodeLabel.Domain.AggregatesModel.LabelSerialCounterAggregate.LabelSerialCounter", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id")
                        .HasComment("Serial counter aggregate id.");

                    b.Property<Guid>("BarcodeRuleId")
                        .HasColumnType("uuid")
                        .HasColumnName("barcode_rule_id")
                        .HasComment("Barcode rule owning the serial namespace.");

                    b.Property<long>("CurrentValue")
                        .HasColumnType("bigint")
                        .HasColumnName("current_value")
                        .HasComment("Last value atomically reserved in this serial namespace.");
                    ...
                    b.Property<string>("EnvironmentId")
                        ...
                        .HasColumnType("character varying(100)")
                        .HasColumnName("environment_id")
                        .HasComment("Environment id owning the serial namespace.");
                    ...
                    b.Property<string>("OrganizationId")
                        ...
                        .HasColumnType("character varying(100)")
                        .HasColumnName("organization_id")
                        .HasComment("Organization tenant id owning the serial namespace.");
                    ...
                    b.ToTable("label_serial_counters", "barcode", t =>
                        {
                            t.HasComment("Persistent per-rule allocator state for generated unit serial numbers.");

                            t.HasCheckConstraint("ck_label_serial_counters_current_value_positive", "current_value > 0");
                        });
                });
