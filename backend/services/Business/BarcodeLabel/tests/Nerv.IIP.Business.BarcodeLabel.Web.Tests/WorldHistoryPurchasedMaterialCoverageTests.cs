...
using ProcurementSpec = Nerv.IIP.Business.BarcodeLabel.Web.Application.Seed.WorldHistoryProcurementSpec;
using PurchasePlanSource = Nerv.IIP.Business.BarcodeLabel.Web.Application.Seed.WorldHistoryProcurementSpec;
