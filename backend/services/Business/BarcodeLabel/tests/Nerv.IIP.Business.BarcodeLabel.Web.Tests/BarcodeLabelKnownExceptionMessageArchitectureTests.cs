...
public sealed class BarcodeLabelKnownExceptionMessageArchitectureTests
{
    ...
    [
        ...
        $"{BarcodeLabelSourceRoot}/Nerv.IIP.Business.BarcodeLabel.Web/Application/Queries/LabelTemplates/GetTemplateAssetRetirementQuery.cs",
    ...
    [
        ...
        Target(SourcePath("Nerv.IIP.Business.BarcodeLabel.Infrastructure/ApplicationDbContext.cs"), "ApplicationDbContext", "TryMapTemplateAssetRetirementUniqueConflict", 2),
        ...
        Target(SourcePath("Nerv.IIP.Business.BarcodeLabel.Web/Application/Commands/PrintBatches/PrintLabelLifecycleCommands.cs"), "ActivateLabelPrintBatchCommandHandler", "Handle", 2),
    ...
    public void BarcodeLabel_transport_visible_known_exceptions_have_a_closed_target_and_exclusion_ledger()
    {
        ...
        Assert.Equal(39, ExpectedSites.Where(site => site.Kind == BarcodeLabelKnownExceptionSiteKind.Target)
            .Sum(site => site.DirectKnownExceptionCount));
        Assert.Equal(13, ExpectedSites.Where(site => site.Kind == BarcodeLabelKnownExceptionSiteKind.Excluded)
            .Sum(site => site.DirectKnownExceptionCount));
