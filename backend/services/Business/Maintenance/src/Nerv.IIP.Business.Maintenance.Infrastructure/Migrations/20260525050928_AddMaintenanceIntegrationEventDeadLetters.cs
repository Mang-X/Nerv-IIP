...
{
    /// <inheritdoc />
    public partial class AddMaintenanceIntegrationEventDeadLetters : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dead_lettered_at_utc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, comment: "UTC time when Maintenance stored the dead-letter message."),
                ...
                comment: "Maintenance integration events rejected before business handling and retained for replay triage.");
