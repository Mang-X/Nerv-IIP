...
namespace Nerv.IIP.Business.Maintenance.Infrastructure.Migrations
{
    ...
    [Migration("20260716050408_MakeMaintenancePlanTriggersOptional")]
    partial class MakeMaintenancePlanTriggersOptional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nerv.IIP.Business.Maintenance.Domain.AggregatesModel.MaintenanceInspectionAggregate.MaintenanceInspection", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "EnvironmentId", "InspectedAtUtc");
            ...
            modelBuilder.Entity("Nerv.IIP.Business.Maintenance.Domain.AggregatesModel.MaintenanceInspectionAggregate.MaintenanceInspectionMeasurement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id")
                        .HasComment("Maintenance inspection measurement line id.");
                    ...
                    b.Property<string>("CharacteristicCode")
                        ...
                        .HasComment("Maintenance-owned characteristic code measured during inspection.");

                    b.Property<bool>("IsWithinSpec")
                        .HasColumnType("boolean")
                        .HasColumnName("is_within_spec")
                        .HasComment("Whether the measured value is inside the configured acceptable range.");

                    b.Property<decimal?>("LowerSpecLimit")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)")
                        .HasColumnName("lower_spec_limit")
                        .HasComment("Optional lower acceptable limit for the measured value.");

                    b.Property<Guid>("MaintenanceInspectionId")
                        .HasColumnType("uuid")
                        .HasColumnName("maintenance_inspection_id")
                        .HasComment("Owning maintenance inspection id.");

                    b.Property<decimal>("MeasuredValue")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)")
                        .HasColumnName("measured_value")
                        .HasComment("Measured numeric value.");
                    ...
                    b.Property<string>("UomCode")
                        ...
                        .HasComment("Unit of measure code for the measured value.");

                    b.Property<decimal?>("UpperSpecLimit")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)")
                        .HasColumnName("upper_spec_limit")
                        .HasComment("Optional upper acceptable limit for the measured value.");

                    b.HasKey("Id");

                    b.HasIndex("CharacteristicCode");

                    b.HasIndex("MaintenanceInspectionId");

                    b.ToTable("maintenance_inspection_measurements", "maintenance", t =>
                        {
                            t.HasComment("Measurement value lines captured during Maintenance inspections.");
                        });
                });
            ...
            modelBuilder.Entity("Nerv.IIP.Business.Maintenance.Domain.AggregatesModel.MaintenancePlanAggregate.MaintenancePlan", b =>
                {
                    ...
                    b.Property<bool>("Paused")
                        ...
                        .HasComment("Whether preventive maintenance generation is paused for this plan.");
            ...
            modelBuilder.Entity("Nerv.IIP.Business.Maintenance.Domain.AggregatesModel.MaintenanceWorkOrderAggregate.MaintenanceWorkOrder", b =>
                {
                    ...
                    b.Property<string>("CostCurrencyCode")
                        ...
                        .HasComment("Currency code for summarized maintenance cost fields.");
                    ...
                    b.Property<int?>("EstimatedLaborMinutes")
                        .HasColumnType("integer")
                    ...
                    b.Property<decimal?>("ExternalServiceCostAmount")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)")
                        .HasColumnName("external_service_cost_amount")
                        .HasComment("External service or outsourcing cost amount captured by Maintenance.");
                    ...
                    b.Property<decimal?>("SparePartCostAmount")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)")
                        .HasColumnName("spare_part_cost_amount")
                        .HasComment("Summarized spare part cost amount captured by Maintenance.");
            ...
            modelBuilder.Entity("Nerv.IIP.Business.Maintenance.Domain.AggregatesModel.MaintenanceInspectionAggregate.MaintenanceInspectionMeasurement", b =>
                {
                    b.HasOne("Nerv.IIP.Business.Maintenance.Domain.AggregatesModel.MaintenanceInspectionAggregate.MaintenanceInspection", null)
