...
{
    /// <inheritdoc />
    public partial class AddMaintenanceConsumerInboxIdempotency : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConsumerName = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false, comment: "BusinessMaintenance integration event consumer name."),
                    ...
                    DedupeKey = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false, comment: "BusinessMaintenance dedupe key associated with the processed event."),
                    ProcessedAtUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, comment: "UTC time when BusinessMaintenance processed the event.")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_processed_integration_events", x => x.Id);
                },
                comment: "Integration events already processed by BusinessMaintenance for idempotent consumption.");
