...
namespace Nerv.IIP.Business.MasterData.Infrastructure.Migrations
{
    ...
    [Migration("20260922083128_NormalizeSkuTrackingPolicyCodes")]
    partial class NormalizeSkuTrackingPolicyCodes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nerv.IIP.Business.MasterData.Domain.AggregatesModel.ScopeContextAuditAggregate.MasterDataScopeContextAuditEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasComment("Scope context audit entry identifier.");

                    b.Property<string>("ActorId")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasComment("Trusted authenticated principal.");

                    b.Property<string>("AfterJson")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasComment("Canonical authorization-relevant state after the mutation.");

                    b.Property<string>("BeforeJson")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasComment("Canonical authorization-relevant state before the mutation.");

                    b.Property<string>("CausationId")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasComment("Request causation identity.");

                    b.Property<string>("CorrelationId")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasComment("Request correlation identity.");
                    ...
                    b.Property<DateTimeOffset>("OccurredAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasComment("UTC timestamp when the mutation occurred.");

                    b.Property<string>("OperationId")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasComment("Idempotency key or correlation identity.");

                    b.Property<string>("OperationKind")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasComment("Stable scope-context mutation kind.");
                    ...
                    b.Property<string>("Reason")
                        ...
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasComment("Normalized reason or stable system reason code.");

                    b.Property<string>("ResourceCode")
                        .IsRequired()
                        .HasMaxLength(160)
                        .HasColumnType("character varying(160)")
                        .HasComment("Stable resource code.");
                    ...
                    b.Property<string>("ResourceIdentity")
                        ...
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)")
                        .HasComment("Canonical resource identity.");
                    ...
                    b.ToTable("master_data_scope_context_audit", "business_masterdata", t =>
                        {
                            t.HasComment("Durable audit trail for master-data changes that alter principal scope candidates.");
                        });
                });
            ...
            modelBuilder.Entity("Nerv.IIP.Business.MasterData.Domain.AggregatesModel.TeamAggregate.Team", b =>
                {
                    ...
                    b.Property<string>("WorkshopCode")
                        ...
                        .HasColumnType("character varying(100)")
                        .HasColumnName("workshop_code")
                        .HasComment("Optional workshop code the team staffs; MES dispatch resolves candidates through work center -> workshop -> team.");
            ...
            modelBuilder.Entity("Nerv.IIP.Business.MasterData.Domain.AggregatesModel.ToolingAssetAggregate.ToolingAuditEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasComment("Tooling audit entry identifier.");

                    b.Property<string>("ActorId")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasComment("Trusted authenticated principal forwarded by the authorized caller.");

                    b.Property<string>("AfterStatus")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                        .HasComment("Tooling status after register or status operation; otherwise null.");

                    b.Property<long?>("AfterUsageCount")
                        .HasColumnType("bigint")
                        .HasComment("Usage count after register or usage operation; otherwise null.");

                    b.Property<string>("BeforeStatus")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                        .HasComment("Tooling status before a status operation; otherwise null.");

                    b.Property<long?>("BeforeUsageCount")
                        .HasColumnType("bigint")
                        .HasComment("Usage count before a usage operation; otherwise null.");
                    ...
                    b.Property<DateTimeOffset>("OccurredAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasComment("UTC timestamp when the governed operation occurred.");

                    b.Property<string>("OperationId")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasComment("Stable idempotency identity for the governed operation.");

                    b.Property<string>("OperationKind")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                        .HasComment("Governed operation: tooling-register, tooling-status, or tooling-usage.");
                    ...
                    b.Property<string>("Reason")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasComment("Normalized status change reason; otherwise null.");
                    ...
                    b.Property<string>("RequestFingerprint")
                        ...
                        .IsFixedLength()
                        .HasComment("SHA-256 fingerprint of the canonical operation, target, and whitelisted request summary.");

                    b.Property<string>("ToolingAssetId")
                        .IsRequired()
                        .HasMaxLength(160)
                        .HasColumnType("character varying(160)")
                        .HasComment("Persistent tooling asset identifier without a cross-table foreign key.");

                    b.Property<string>("ToolingCode")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasComment("Canonical tooling code targeted by the operation.");

                    b.Property<long?>("UsageDelta")
                        .HasColumnType("bigint")
                        .HasComment("Positive usage increment for a usage operation; otherwise null.");
                    ...
                    b.HasIndex("OrganizationId", "EnvironmentId", "ToolingCode", "OccurredAtUtc")
                        .HasDatabaseName("ix_tooling_audit_target_time");

                    b.ToTable("tooling_audit_entries", "business_masterdata", t =>
                        {
                            t.HasComment("Append-only audit facts for governed tooling register, status, and usage operations.");

                            t.HasCheckConstraint("ck_tooling_audit_operation_kind", "\"OperationKind\" IN ('tooling-register', 'tooling-status', 'tooling-usage')");

                            t.HasCheckConstraint("ck_tooling_audit_summary_shape", "(\"OperationKind\" = 'tooling-register' AND \"BeforeStatus\" IS NULL AND \"AfterStatus\" = 'Available' AND \"BeforeUsageCount\" IS NULL AND \"AfterUsageCount\" = 0 AND \"UsageDelta\" IS NULL AND \"Reason\" IS NULL) OR (\"OperationKind\" = 'tooling-status' AND \"BeforeStatus\" IS NOT NULL AND \"AfterStatus\" IS NOT NULL AND \"BeforeUsageCount\" IS NULL AND \"AfterUsageCount\" IS NULL AND \"UsageDelta\" IS NULL AND \"Reason\" IS NOT NULL) OR (\"OperationKind\" = 'tooling-usage' AND \"BeforeStatus\" IS NULL AND \"AfterStatus\" IS NULL AND \"BeforeUsageCount\" >= 0 AND \"AfterUsageCount\" = \"BeforeUsageCount\" + \"UsageDelta\" AND \"UsageDelta\" > 0 AND \"Reason\" IS NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Nerv.IIP.Business.MasterData.Domain.AggregatesModel.WorkerAggregate.Worker", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id")
                        .HasComment("Worker aggregate id.");
                    ...
                    b.Property<string>("Code")
                        ...
                        .HasColumnType("character varying(100)")
                        .HasColumnName("code")
                        .HasComment("Human readable employee number shown on shop floor screens.");

                    b.Property<DateTime>("CreatedAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("created_at_utc")
                        .HasComment("UTC time when the worker record was created.");

                    b.Property<string>("DepartmentCode")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("department_code")
                        .HasComment("Optional department code the worker belongs to.");

                    b.Property<bool>("Disabled")
                        .HasColumnType("boolean")
                        .HasColumnName("disabled")
                        .HasComment("Soft delete flag for archived workers.");
                    ...
                    b.Property<string>("EmploymentStatus")
                        ...
                        .HasComment("Duty status of the worker: active, on-leave, or resigned.");
                    ...
                    b.Property<string>("EnvironmentId")
                        ...
                        .HasColumnType("character varying(100)")
                        .HasColumnName("environment_id")
                        .HasComment("Environment id where the worker record is valid.");

                    b.Property<string>("JobTitle")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("job_title")
                        .HasComment("Optional job title of the worker.");
                    ...
                    b.Property<string>("Name")
                        ...
                        .HasColumnType("character varying(200)")
                        .HasColumnName("name")
                        .HasComment("Worker display name.");
                    ...
                    b.Property<string>("OrganizationId")
                        ...
                        .HasColumnType("character varying(100)")
                        .HasColumnName("organization_id")
                        .HasComment("Organization tenant id that owns the worker record.");

                    b.Property<string>("Phone")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("phone")
                        .HasComment("Optional contact phone number.");

                    b.Property<DateTime>("UpdatedAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("updated_at_utc")
                        .HasComment("UTC time when the worker record was last updated.");
                    ...
                    b.Property<string>("UserId")
                        ...
                        .HasColumnType("character varying(100)")
                        .HasColumnName("user_id")
                        .HasComment("Stable person identifier shared with team membership, personnel skills, and MES dispatch.");
                    ...
                    b.HasIndex("OrganizationId", "EnvironmentId", "UserId")
                        .IsUnique();

                    b.HasIndex("OrganizationId", "EnvironmentId", "DepartmentCode", "Disabled");

                    b.ToTable("workers", "business_masterdata", t =>
                        {
                            t.HasComment("Business master data factory workers used by team membership, personnel skills, and MES dispatch.");
                        });
                });
