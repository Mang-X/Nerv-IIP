...
public sealed class MasterDataPostgresProfileTests
{
    ...
    public async Task Postgres_store_persists_master_data_aggregates()
    {
        ...
        using (var scope = provider.CreateScope())
        {
            ...
            calendar.AddWorkingTime(DayOfWeek.Monday, new TimeOnly(8, 0), new TimeOnly(16, 0));
            ...
            await handler.Handle(
                new UpdateMasterDataResourceCommand(
                    ...
                    [
                        ...
                        new WorkCalendarWorkingTimeDetail(DayOfWeek.Tuesday, new TimeOnly(13, 0), new TimeOnly(17, 0))
                    ],
        ...
        using (var secondUpdateScope = provider.CreateScope())
        {
            ...
            await handler.Handle(
                new UpdateMasterDataResourceCommand(
                    ...
                    "work-calendar",
                    "CAL-001",
                    WorkingTimes: [new WorkCalendarWorkingTimeDetail(DayOfWeek.Wednesday, new TimeOnly(10, 0), new TimeOnly(16, 0))],
