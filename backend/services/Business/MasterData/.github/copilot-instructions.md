...
```
Nerv.IIP.Business.MasterData.sln
├── src/
│   ├── Nerv.IIP.Business.MasterData.Domain/         # 领域层 - 聚合根、实体、领域事件
│   ├── Nerv.IIP.Business.MasterData.Infrastructure/ # 基础设施层 - EF配置、仓储接口、仓储实现
│   └── Nerv.IIP.Business.MasterData.Web/           # 表现层 - API、应用服务
└── test/                            # 测试项目
    ├── Nerv.IIP.Business.MasterData.Domain.UnitTests/         # 领域层测试项目
    ├── Nerv.IIP.Business.MasterData.Infrastructure.UnitTests/ # 基础设施层测试项目
    └── Nerv.IIP.Business.MasterData.Web.UnitTests/           # 表现层测试项目
```
...
### 文件组织
- **聚合根** → `src/Nerv.IIP.Business.MasterData.Domain/AggregatesModel/{AggregateFolder}/`
- **领域事件** → `src/Nerv.IIP.Business.MasterData.Domain/DomainEvents/`
- **仓储** → `src/Nerv.IIP.Business.MasterData.Infrastructure/Repositories/`
- **实体配置** → `src/Nerv.IIP.Business.MasterData.Infrastructure/EntityConfigurations/`
- **命令与命令处理器** → `src/Nerv.IIP.Business.MasterData.Web/Application/Commands/`
- **查询与查询处理器** → `src/Nerv.IIP.Business.MasterData.Web/Application/Queries/`
- **API端点** → `src/Nerv.IIP.Business.MasterData.Web/Endpoints/`
- **领域事件处理器** → `src/Nerv.IIP.Business.MasterData.Web/Application/DomainEventHandlers/`
- **集成事件** → `src/Nerv.IIP.Business.MasterData.Web/Application/IntegrationEvents/`
- **集成事件转换器** → `src/Nerv.IIP.Business.MasterData.Web/Application/IntegrationEventConverters/`
- **集成事件处理器** → `src/Nerv.IIP.Business.MasterData.Web/Application/IntegrationEventHandlers/`
...
**Web层** (`src/Nerv.IIP.Business.MasterData.Web/GlobalUsings.cs`):
...
**Infrastructure层** (`src/Nerv.IIP.Business.MasterData.Infrastructure/GlobalUsings.cs`):
...
**Domain层** (`src/Nerv.IIP.Business.MasterData.Domain/GlobalUsings.cs`):
...
**查询处理器**:
```csharp
using Nerv.IIP.Business.MasterData.Domain.AggregatesModel.{AggregateFolder};
...
```csharp
using Nerv.IIP.Business.MasterData.Domain.AggregatesModel.{AggregateFolder};
using Nerv.IIP.Business.MasterData.Web.Application.Commands.{FeatureFolder};
using Nerv.IIP.Business.MasterData.Web.Application.Queries.{FeatureFolder};
```