---
applyTo: "src/Nerv.IIP.Business.MasterData.Web/Application/Commands/**/*.cs"
---
...
- 类文件应放置在 `src/Nerv.IIP.Business.MasterData.Web/Application/Commands/{Module}s/` 目录下（以模块复数形式命名，避免命名空间与聚合类名冲突）。
...
**文件**: `src/Nerv.IIP.Business.MasterData.Web/Application/Commands/Users/CreateUserCommand.cs`

```csharp
using Nerv.IIP.Business.MasterData.Domain.AggregatesModel.UserAggregate;
using Nerv.IIP.Business.MasterData.Infrastructure.Repositories;

namespace Nerv.IIP.Business.MasterData.Web.Application.Commands.Users;
