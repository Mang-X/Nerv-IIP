---
applyTo: "src/Nerv.IIP.Business.MasterData.Infrastructure/Repositories/*.cs"
---
...
- 仓储接口和实现应放置在 `src/Nerv.IIP.Business.MasterData.Infrastructure/Repositories/` 目录下。
- 文件名格式为 `{AggregateName}Repository.cs`。

## 代码示例

**文件**: `src/Nerv.IIP.Business.MasterData.Infrastructure/Repositories/AdminUserRepository.cs`

```csharp
using Nerv.IIP.Business.MasterData.Domain.AggregatesModel.AdminUserAggregate;
