---
applyTo: "src/Nerv.IIP.Business.MasterData.Web/Endpoints/**/*.cs"
---
...
- 类文件应放置在 `src/Nerv.IIP.Business.MasterData.Web/Endpoints/{Module}/` 目录下。
- 端点文件名格式为 `{Action}{Entity}Endpoint.cs`。
- 请求 DTO、响应 DTO 与端点定义在同一文件中。

## 代码示例

**文件**: `src/Nerv.IIP.Business.MasterData.Web/Endpoints/User/CreateUserEndpoint.cs`

```csharp
using FastEndpoints;
using Nerv.IIP.Business.MasterData.Web.Application.Commands;
using Nerv.IIP.Business.MasterData.Domain.AggregatesModel.UserAggregate;
using Microsoft.AspNetCore.Authorization;

namespace Nerv.IIP.Business.MasterData.Web.Endpoints.User;
