...
- 领域层测试：`test/Nerv.IIP.Business.MasterData.Domain.Tests/{EntityName}Tests.cs`。
- Web 层测试：`test/Nerv.IIP.Business.MasterData.Web.Tests/{Feature}Tests.cs`。
- 基础设施层测试：`test/Nerv.IIP.Business.MasterData.Infrastructure.Tests/{Component}Tests.cs`。
