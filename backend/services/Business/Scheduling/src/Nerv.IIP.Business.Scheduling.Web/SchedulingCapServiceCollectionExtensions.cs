...
namespace Nerv.IIP.Business.Scheduling.Web;
...
/// </summary>
public static class SchedulingCapServiceCollectionExtensions
{
    public static IServiceCollection AddSchedulingCapIntegrationEvents(
