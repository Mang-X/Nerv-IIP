...
{
    /// <inheritdoc />
    public partial class AddDeviceControlOutcomeAndDeadLetters : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AddColumn<string>(
                ...
                maxLength: 100,
                nullable: true,
                comment: "Machine-readable failure code from Ops when the command failed; null otherwise.");
            ...
            migrationBuilder.AddColumn<DateTimeOffset>(
                ...
                nullable: true,
                comment: "UTC time the Ops task reached a terminal outcome (completed/failed/rejected); null while in flight.");
