...
namespace Nerv.IIP.Business.IndustrialTelemetry.Infrastructure.Migrations
{
    ...
    [Migration("20260825173218_AddOeeHistoricalDimensionBuckets")]
    partial class AddOeeHistoricalDimensionBuckets
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Nerv.IIP.Business.IndustrialTelemetry.Domain.AggregatesModel.OeeProductionFactAggregate.OeeProductionFact", b =>
                {
                    ...
                    b.Property<DateOnly?>("BusinessDate")
                        ...
                        .HasComment("Site-local calendar date containing the report.");

                    b.Property<DateTimeOffset?>("DayBucketEndUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("day_bucket_end_utc")
                        .HasComment("UTC end of the captured site-local business day.");

                    b.Property<DateTimeOffset?>("DayBucketStartUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("day_bucket_start_utc")
                    ...
                    b.Property<string>("LineCode")
                        ...
                        .HasComment("MasterData production line code snapshot captured by MES when the report was recorded.");
                    ...
                    b.Property<DateTimeOffset?>("ShiftBucketEndUtc")
                        ...
                        .HasComment("UTC end of the captured shift instance.");

                    b.Property<DateTimeOffset?>("ShiftBucketStartUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("shift_bucket_start_utc")
                        .HasComment("UTC start of the captured shift instance.");

                    b.Property<DateOnly?>("ShiftBusinessDate")
                        .HasColumnType("date")
                        .HasColumnName("shift_business_date")
                        .HasComment("Local date on which the captured shift instance starts.");

                    b.Property<string>("ShiftCode")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("shift_code")
                        .HasComment("Assigned MasterData shift code snapshot captured by MES when the report was recorded.");
                    ...
                    b.Property<TimeOnly?>("ShiftEndsAt")
                        ...
                        .HasComment("Captured local shift end time.");
                    ...
                    b.Property<TimeOnly?>("ShiftStartsAt")
                        ...
                        .HasComment("Captured local shift start time.");

                    b.Property<string>("SiteCode")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("site_code")
                        .HasComment("MasterData site code snapshot captured by MES when the report was recorded.");

                    b.Property<string>("SiteTimezone")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("site_timezone")
                        .HasComment("IANA site timezone snapshot used for historical day and shift boundaries.");
                    ...
                    b.Property<string>("WorkshopCode")
                        ...
                        .HasComment("MasterData workshop code snapshot captured by MES when the report was recorded.");
