...
public sealed class IndustrialTelemetryEndpointContractTests
{
    ...
    public void IndustrialTelemetry_endpoints_expose_issue_129_routes_permissions_policies_and_operation_ids()
    {
        ...
        Assert.Contains(contracts, x => x.HttpMethod == "POST" && x.Route == "/api/business/v1/iiot/device-control-bindings" && x.PermissionCode == IndustrialTelemetryPermissionCodes.DeviceControlWrite && x.OperationId == "createOrUpdateBusinessIiotDeviceControlBinding");
        Assert.Contains(contracts, x => x.HttpMethod == "POST" && x.Route == "/api/business/v1/iiot/device-control-bindings/{deviceAssetId}/disable" && x.PermissionCode == IndustrialTelemetryPermissionCodes.DeviceControlWrite && x.OperationId == "disableBusinessIiotDeviceControlBinding");
