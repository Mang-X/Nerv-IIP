...
public sealed class MaterialIssueRequestEntityTypeConfiguration : IEntityTypeConfiguration<MaterialIssueRequest>
{
    public void Configure(EntityTypeBuilder<MaterialIssueRequest> builder)
    {
        ...
        builder.Property(x => x.PendingIssueLegPostedIndexesJson).HasColumnName("pending_issue_leg_posted_indexes_json").HasColumnType("text").IsRequired().HasDefaultValue("[]").HasComment("JSON array of warehouse outbound detail indexes already acknowledged by Inventory.");
