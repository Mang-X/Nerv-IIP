...
public sealed class ProductionReportEntityTypeConfiguration : IEntityTypeConfiguration<ProductionReport>
{
    public void Configure(EntityTypeBuilder<ProductionReport> builder)
    {
        ...
        builder.Property(x => x.ReportIntentFingerprint).HasColumnName("report_intent_fingerprint").HasMaxLength(ProductionReport.ReportIntentFingerprintMaxLength).HasComment("Optional opaque caller intent fingerprint used to recover the exact production report receipt.");
