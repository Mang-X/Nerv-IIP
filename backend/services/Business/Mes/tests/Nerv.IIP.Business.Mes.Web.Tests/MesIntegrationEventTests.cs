...
{
    [Fact]
    public void Production_report_converter_emits_inventory_outbound_requests_for_consumed_lots()
    {
    ...
    [Fact]
    public void Material_issue_converter_emits_inventory_outbound_request_for_pick_intent()
    {
        ...
        var integrationEvent = new MaterialIssueRequestedIntegrationEventConverter()
            .Convert(new MaterialIssueRequestedDomainEvent(request));
