...
public sealed class MesKnownExceptionMessageArchitectureTests
{
    ...
    [
        ...
        Excluded("backend/services/Business/Mes/src/Nerv.IIP.Business.Mes.Web/Application/Commands/Workbench/MesWorkerSkillQualificationGate.cs", "HttpMesWorkerSkillQualificationGate", "EnsureQualifiedAsync", 13, "中文业务拒绝与稳定错误码 WORKER_SKILL_SOURCE_UNAVAILABLE"),
    ...
    public void Static_target_and_exclusion_ledger_matches_the_current_MES_source()
    {
        ...
        Assert.Equal(132, discovered.Sum(site => site.DirectKnownExceptionCount));
        Assert.Equal(129, documents.Sum(document => CountOccurrences(document.Text, "new KnownException")));
