...
namespace Nerv.IIP.Business.Inventory.Infrastructure.Migrations
{
    ...
    [Migration("20260825202829_AddInventoryAuthorityResolutionPendingAudit")]
    partial class AddInventoryAuthorityResolutionPendingAudit
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Nerv.IIP.Business.Inventory.Domain.AggregatesModel.StockLedgerAggregate.StockLedger", b =>
                {
                    ...
                    b.Property<string>("ExpiryDateSource")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("expiry_date_source")
                        .HasComment("Persisted expiry provenance: direct, derived, mixed, or null when unknown.");
                    ...
                    b.Property<int?>("ShelfLifeDays")
                        ...
                        .HasComment("Shelf-life days used when the persisted expiry date was derived; null for direct, mixed, or historical provenance.");
                    ...
                    b.ToTable("stock_ledgers", "inventory", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_stock_ledgers_expiry_date_source", "expiry_date_source is null or expiry_date_source in ('direct','derived','mixed')");

                            t.HasCheckConstraint("ck_stock_ledgers_expiry_provenance", "(expiry_date_source is null and shelf_life_days is null) or (expiry_date_source is not null and ((expiry_date_source = 'derived' and production_date is not null and expiry_date is not null and shelf_life_days between 1 and 3660 and expiry_date - production_date = shelf_life_days) or (expiry_date_source in ('direct','mixed') and expiry_date is not null and shelf_life_days is null)))");
            ...
            modelBuilder.Entity("Nerv.IIP.Business.Inventory.Domain.AggregatesModel.StockMovementAggregate.StockMovement", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "EnvironmentId", "SourceService", "SourceDocumentId", "SourceDocumentLineId", "PostedAtUtc")
                        .HasDatabaseName("IX_stock_movements_organization_id_environment_id_source_serv~1");
