...
public static class WmsEndpointContracts
{
    ...
    [
        ...
        new(typeof(CreateCountExecutionEndpoint), "POST", "/api/business/v1/wms/count-executions", WmsPermissionCodes.InventoryCountsManage, InternalServiceAuthorizationPolicy.Name, "createWmsCountExecution"),
        ...
        new(typeof(AssignCountExecutionEndpoint), "POST", "/api/business/v1/wms/count-executions/{countExecutionId}/assignment", WmsPermissionCodes.InventoryCountsManage, InternalServiceAuthorizationPolicy.Name, "assignWmsCountExecution"),
        new(typeof(CompleteCountExecutionEndpoint), "POST", "/api/business/v1/wms/count-executions/{countExecutionId}/complete", WmsPermissionCodes.InventoryCountsManage, InternalServiceAuthorizationPolicy.Name, "completeWmsCountExecution"),
