...
public sealed class ProcessedIntegrationEvent : Entity<ProcessedIntegrationEventId>
{
    ...
    public ProcessedIntegrationEvent(string consumerName, string eventId, string eventType, int eventVersion, string sourceService, string idempotencyKey, DateTimeOffset processedAtUtc)
    {
