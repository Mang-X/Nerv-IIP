...
public static class QualityInspectionEndpointContracts
{
    ...
    [
        ...
        new(typeof(InspectionRecords.CreateReinspectionEndpoint), "POST", "/api/business/v1/quality/inspection-records/{inspectionRecordId}/reinspections", BusinessPermissionCodes.QualityInspectionRecordsCreate, "createBusinessQualityReinspection"),
        ...
        new(typeof(MeasuringDevices.ListMeasuringDevicesEndpoint), "GET", "/api/business/v1/quality/measuring-devices", BusinessPermissionCodes.QualityMeasuringDevicesRead, "listBusinessQualityMeasuringDevices"),
        new(typeof(MeasuringDevices.ListCalibrationRecordsEndpoint), "GET", "/api/business/v1/quality/calibration-records", BusinessPermissionCodes.QualityMeasuringDevicesRead, "listBusinessQualityCalibrationRecords"),
        new(typeof(Nerv.IIP.Business.Quality.Web.Endpoints.Spc.ListSpcControlChartsEndpoint), "GET", "/api/business/v1/quality/spc/control-charts", BusinessPermissionCodes.QualityInspectionRecordsRead, "listBusinessQualitySpcControlCharts"),
