...
public sealed class InspectionPlan : Entity<InspectionPlanId>, IAggregateRoot
{
        ...
        string samplingRule)
    {
        ...
        Characteristics.Add(new InspectionPlanCharacteristic(normalizedCode, name, method, severity, required, samplingRule));
        Touch();
    }
...
public sealed class InspectionPlanCharacteristic : Entity<InspectionPlanCharacteristicId>
{
    ...
    {
        return new InspectionPlanCharacteristic(CharacteristicCode, Name, Method, Severity, IsRequired, SamplingRule);
    }
