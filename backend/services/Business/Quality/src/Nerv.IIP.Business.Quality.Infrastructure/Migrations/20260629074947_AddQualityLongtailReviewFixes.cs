            ...
            migrationBuilder.Sql(
                ...
                BEGIN
                    ...
                    IF duplicate_key IS NOT NULL THEN
                        RAISE EXCEPTION 'Cannot add unique inspection source/SKU index because duplicate Quality inspection records already exist: %. Resolve historical duplicates with docs/reports/remediation/business-quality-inspection-duplicates.md before applying migration 20260629074947_AddQualityLongtailReviewFixes.', duplicate_key;
                    END IF;
                END $$;
                """);
