...
namespace Nerv.IIP.Business.Quality.Infrastructure.Migrations
{
    ...
    [Migration("20260825075733_AddPeriodicInspectionQuantityContinuationFairness")]
    partial class AddPeriodicInspectionQuantityContinuationFairness
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nerv.IIP.Business.Quality.Domain.AggregatesModel.InspectionPlanAggregate.InspectionPlan", b =>
                {
                    ...
                    b.Property<string>("AssignedInspectorUserId")
                        ...
                        .HasComment("Optional inspector user target copied to generated periodic inspection tasks.");

                    b.Property<string>("AssignedTeamId")
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)")
                        .HasColumnName("assigned_team_id")
                        .HasComment("Optional team target copied to generated periodic inspection tasks.");
                    ...
                    b.Property<decimal?>("TimeIntervalHours")
                        ...
                        .HasComment("Optional positive hour interval for periodic operation inspection task generation.");
                    ...
                    b.ToTable("inspection_plans", "quality", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_inspection_plans_periodic_assignment_requires_interval", "(assigned_inspector_user_id IS NULL AND assigned_team_id IS NULL) OR time_interval_hours IS NOT NULL OR quantity_interval IS NOT NULL");

                            t.HasCheckConstraint("ck_inspection_plans_periodic_assignment_target", "assigned_inspector_user_id IS NULL OR assigned_team_id IS NULL");

                            t.HasCheckConstraint("ck_inspection_plans_periodic_policy_applicability", "(time_interval_hours IS NULL AND quantity_interval IS NULL AND assigned_inspector_user_id IS NULL AND assigned_team_id IS NULL) OR (sku_code IS NOT NULL AND work_center_id IS NOT NULL)");

                            t.HasCheckConstraint("ck_inspection_plans_periodic_policy_operation_only", "category = 'operation' OR (time_interval_hours IS NULL AND quantity_interval IS NULL AND assigned_inspector_user_id IS NULL AND assigned_team_id IS NULL)");

                            t.HasCheckConstraint("ck_inspection_plans_quantity_interval_positive", "quantity_interval IS NULL OR quantity_interval > 0");

                            t.HasCheckConstraint("ck_inspection_plans_time_interval_positive", "time_interval_hours IS NULL OR time_interval_hours > 0");
                        });
                });
            ...
            modelBuilder.Entity("Nerv.IIP.Business.Quality.Domain.AggregatesModel.InspectionTaskAggregate.InspectionTask", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id")
                    ...
                    b.Property<string>("BatchNo")
                        ...
                        .HasColumnType("character varying(100)")
                        .HasColumnName("batch_no")
                        .HasComment("Optional lot or batch number from the source event.");

                    b.Property<DateTimeOffset?>("CompletedAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("completed_at_utc")
                        .HasComment("UTC time when inspection work completed.");

                    b.Property<DateTimeOffset>("CreatedAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("created_at_utc")
                        .HasComment("UTC time when the task was generated.");

                    b.Property<DateTimeOffset>("DueAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("due_at_utc")
                        .HasComment("UTC due time for overdue inspection reminders.");
                    ...
                    b.Property<string>("EnvironmentId")
                        ...
                        .HasColumnType("character varying(100)")
                        .HasColumnName("environment_id")
                        .HasComment("Environment id where the task applies.");

                    b.Property<Guid>("InspectionPlanId")
                        .HasColumnType("uuid")
                        .HasColumnName("inspection_plan_id")
                        .HasComment("Matched active inspection plan id.");

                    b.Property<Guid?>("InspectionRecordId")
                        .HasColumnType("uuid")
                        .HasColumnName("inspection_record_id")
                        .HasComment("Inspection record id created from this task once completed.");
                    ...
                    b.Property<string>("OrganizationId")
                        ...
                        .HasColumnType("character varying(100)")
                        .HasColumnName("organization_id")
                        .HasComment("Organization tenant id that owns the task.");

                    b.Property<DateTimeOffset?>("OverdueReminderSentAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("overdue_reminder_sent_at_utc")
                        .HasComment("UTC time when the overdue reminder event was first emitted.");

                    b.Property<decimal>("Quantity")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)")
                        .HasColumnName("quantity")
                        .HasComment("Quantity awaiting inspection.");

                    b.Property<string>("SerialNo")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("serial_no")
                        .HasComment("Optional serial number from the source event.");
                    ...
                    b.Property<string>("SkuCode")
                        ...
                        .HasColumnType("character varying(100)")
                        .HasColumnName("sku_code")
                        .HasComment("SKU code awaiting inspection.");
                    ...
                    b.Property<string>("SourceDocumentLineId")
                        ...
                        .HasComment("Optional source document line, operation id or stable periodic-operation window identity.");
                    ...
                    b.Property<string>("SourceService")
                        ...
                        .HasColumnType("character varying(100)")
                        .HasColumnName("source_service")
                        .HasComment("Upstream service that emitted the task source event.");
                    ...
                    b.Property<DateTimeOffset?>("StartedAtUtc")
                        ...
                        .HasComment("UTC time when inspection work started.");
                    ...
                    b.Property<string>("Status")
                        ...
                        .HasColumnType("character varying(50)")
                        .HasColumnName("status")
                        .HasComment("Inspection task status: pending, in-progress or completed.");
                    ...
                    b.Property<string>("UomCode")
                        ...
                        .HasColumnType("character varying(50)")
                        .HasColumnName("uom_code")
                        .HasComment("Task quantity unit of measure code.");
            ...
            modelBuilder.Entity("Nerv.IIP.Business.Quality.Domain.AggregatesModel.PeriodicInspectionOperationAggregate.PeriodicInspectionRuntimeContext", b =>
                {
                    ...
                    b.Property<long>("LastGeneratedTimeWindowSequence")
                        ...
                        .HasComment("Last atomically generated time-window sequence; zero before generation.");

                    b.Property<DateTime?>("NextTimeWindowAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("next_time_window_at_utc")
                        .HasComment("Persisted UTC due time for the next ungenerated time window; null before activity or after closure.");
                    ...
                    b.Property<DateTime?>("TimeScheduleAnchorAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("time_schedule_anchor_at_utc")
                        .HasComment("Frozen UTC first-production anchor after the first time window is generated.");
                    ...
                    b.ToTable("periodic_inspection_runtime_contexts", "quality", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_periodic_inspection_runtime_time_watermark", "(last_generated_time_window_sequence = 0 AND time_schedule_anchor_at_utc IS NULL) OR (last_generated_time_window_sequence > 0 AND time_schedule_anchor_at_utc IS NOT NULL)");
                        });
                });
