...
namespace Nerv.IIP.AppHub.Infrastructure.Migrations
{
    ...
    [Migration("20260713020020_AddConnectorCollectionHealthProjection")]
    partial class AddConnectorCollectionHealthProjection
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nerv.IIP.AppHub.Domain.AggregatesModel.ApplicationInstanceAggregate.ApplicationInstance", b =>
                {
                    ...
                    b.Property<string>("ConnectorHostId")
                        ...
                        .HasMaxLength(160)
                        .HasColumnType("character varying(160)")
                        .HasComment("Connector Host protocol identity that owns the instance heartbeat and state reports.");
            ...
            modelBuilder.Entity("Nerv.IIP.AppHub.Infrastructure.IntegrationEvents.ProcessedIntegrationEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTimeOffset>("ProcessedAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasComment("UTC time when AppHub processed the event.");
                    ...
                    b.ToTable("processed_integration_events", "apphub", t =>
                        {
                            t.HasComment("Integration events already processed by AppHub for idempotent consumption.");
                        });
                });
