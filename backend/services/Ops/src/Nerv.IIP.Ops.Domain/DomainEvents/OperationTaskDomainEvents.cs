...
public sealed record OperationTaskCompletedDomainEvent(OperationTask OperationTask, OperationAttempt Attempt, OperationResultInput Result) : IDomainEvent;
public sealed record OperationTaskFailedDomainEvent(OperationTask OperationTask, OperationAttempt Attempt, OperationResultInput Result) : IDomainEvent;
