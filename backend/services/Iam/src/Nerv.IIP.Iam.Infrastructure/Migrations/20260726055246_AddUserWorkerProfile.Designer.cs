...
namespace Nerv.IIP.Iam.Infrastructure.Migrations
{
    ...
    [Migration("20260726055246_AddUserWorkerProfile")]
    partial class AddUserWorkerProfile
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Nerv.IIP.Iam.Domain.AggregatesModel.UserAggregate.User", b =>
                {
                    ...
                    b.Property<string>("DepartmentName")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                        .HasComment("Optional department display name shown in the worker directory.");

                    b.Property<string>("DisplayName")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                        .HasComment("Optional worker display name shown in the worker directory.");
                    ...
                    b.Property<string>("EmployeeNo")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasComment("Optional employee number shown in the worker directory.");
