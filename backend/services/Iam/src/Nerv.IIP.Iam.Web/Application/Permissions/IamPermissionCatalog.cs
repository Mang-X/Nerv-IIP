...
public static class IamPermissionCatalog
{
    private static readonly IReadOnlyDictionary<string, string> Descriptions = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["business.wms.work-pools.manage"] = "Provision WMS field work pools and their operator memberships.",
        ...
        ["business.iiot.device-control.manage"] = "Maintain IndustrialTelemetry device control channel bindings (device to connector host/instance routing).",
