...
public sealed class BusinessGatewayWmsTests
{
    ...
    public async Task Wms_http_client_forwards_list_paging_status_and_keyword_filters_to_backend_wms_paths()
    {
        ...
        var gates = await client.ListReceivingQualityGatesAsync("internal-token-001", new BusinessConsoleWmsReceivingQualityGateListRequest("org-001", "env-dev", 5, 15, "rejected", "IN-GATE", IncludeNotRequired: true), CancellationToken.None);
        ...
        [
            ...
            "GET /api/business/v1/wms/receiving-quality-gates?organizationId=org-001&environmentId=env-dev&skip=5&take=15&gateStatus=rejected&keyword=IN-GATE&includeNotRequired=true",
