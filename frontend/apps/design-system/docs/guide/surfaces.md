...
<div class="ds-surfaces">
  <a class="ds-surface" href="/components/desktop/">
    ...
    <span class="ds-surface-desc">控制台主表面：信息密度高、键鼠为主。紧凑 36–40px 触控目标，语义令牌 + 12 色动态板，Pro 组件（NvDataTable、描述列表、时间线、图表）。克制动效，专业感优先。</span>
    <span class="ds-surface-tag"><code>@nerv-iip/ui</code> · <code>--nv-*</code> · 36–40px</span>
  ...
  <a class="ds-surface" href="/components/mobile/">
    ...
    <span class="ds-surface-tag"><code>@nerv-iip/ui-mobile</code> · <code>--nv-m-*</code> · 40–48px</span>
    <span class="ds-surface-go">移动控件 <ArrowRightIcon /></span>
  </a>
  <a class="ds-surface" href="/components/touch/">
    <span class="ds-surface-icon"><TabletIcon /></span>
    <span class="ds-surface-name">一体机 / 工位</span>
    <span class="ds-surface-desc">工位一体机：近距离大触控、减少路径。56–72px 大触控目标，工单大卡、报工步进、节拍图，为"少点几下完成报工"而设计。大量复用 PC 件（放大字号间距）。</span>
    <span class="ds-surface-tag"><code>@nerv-iip/ui · touch/</code> · <code>--nv-t-*</code> · 56–72px</span>
    <span class="ds-surface-go">一体机组件 <ArrowRightIcon /></span>
  </a>
  <a class="ds-surface" href="/components/screen/">
    <span class="ds-surface-icon"><PresentationIcon /></span>
    <span class="ds-surface-name">大屏 / 控制室</span>
    <span class="ds-surface-desc">挂墙大屏：远距离可读、几乎不触控。独立的近黑工业蓝令牌层（<code>--nv-scr-*</code>），发光克制、白色发丝线撑结构，舞台缩放适配任意分辨率。</span>
    <span class="ds-surface-tag"><code>@nerv-iip/ui · screen/</code> · <code>--nv-scr-*</code> · 远读</span>
    <span class="ds-surface-go">大屏组件 <ArrowRightIcon /></span>
  </a>
</div>
...
@media (min-width: 640px) {
  .ds-surfaces { grid-template-columns: repeat(2, 1fr); }
}
@media (min-width: 1100px) {
  .ds-surfaces { grid-template-columns: repeat(4, 1fr); }
}
.ds-surface {
  display: flex;
