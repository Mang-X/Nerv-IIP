...
| 插槽      | 说明                                                      |
| --------- | --------------------------------------------------------- |
| `header`  | 顶部固定区，通常放 [NvNavBar](/components/mobile/nav-bar) |
| `default` | 可滚动主体内容                                            |
| `footer`  | 底部固定区，通常放 [NvTabBar](/components/mobile/tab-bar) |
