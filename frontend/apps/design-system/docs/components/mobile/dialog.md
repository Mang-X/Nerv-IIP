...
<script setup>
import { MobileButton, MobileDialog } from '@nerv-iip/ui-mobile'
import { ref } from 'vue'
...
<template #phone>
  <section>
    ...
    <MobileButton variant="default" size="md" block @click="confirmOpen = true">
      居中确认
    </MobileButton>
    <MobileDialog
  ...
  <section>
    ...
    <MobileButton variant="danger" size="md" block @click="dangerOpen = true">
      危险确认
    </MobileButton>
    <MobileDialog
