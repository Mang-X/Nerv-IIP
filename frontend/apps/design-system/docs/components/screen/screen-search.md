...
<script setup>
import { ref } from 'vue'
import { ScreenSearch } from '@nerv-iip/ui'
...
<ScreenDemo>
  <div style="display:flex;flex-direction:column;gap:12px;width:320px">
    <ScreenSearch v-model="kw" placeholder="搜索工单号或产品" />
    <ScreenSearch v-model="empty" placeholder="搜索工单号或产品" />
  </div>
</ScreenDemo>
...
<ScreenDemo>
  <div style="width:320px">
    <ScreenSearch model-value="" disabled placeholder="检索已锁定" />
  </div>
</ScreenDemo>

```vue
<ScreenSearch disabled placeholder="检索已锁定" />
```
