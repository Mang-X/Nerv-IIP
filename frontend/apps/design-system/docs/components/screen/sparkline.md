...
<script setup>
import { ref } from 'vue'
import { NvSparkline, NvScreenPanel } from '@nerv-iip/ui'
...
<ScreenDemo>
  <NvScreenPanel title="良品率趋势" style="width: 320px">
    <div style="height: 56px">
      <NvSparkline :data="yieldSeries" />
    </div>
  </NvScreenPanel>
</ScreenDemo>

```vue
<NvScreenPanel title="良品率趋势">
  <div style="height: 56px">
    <NvSparkline :data="series" />
  </div>
</NvScreenPanel>
```
...
<ScreenDemo>
  <NvScreenPanel title="主轴温度（℃）" style="width: 320px">
    <div style="height: 56px">
      <NvSparkline :data="tempSeries" area />
    </div>
  </NvScreenPanel>
</ScreenDemo>

```vue
<NvSparkline :data="series" area />
```
