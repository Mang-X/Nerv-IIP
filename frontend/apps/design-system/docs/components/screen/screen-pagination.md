...
<script setup>
import { ScreenPagination, ScreenPanel } from '@nerv-iip/ui'
import { ref } from 'vue'
...
<ScreenDemo wide>
  <ScreenPanel>
    <ScreenPagination v-model:page="page" :total="248" :page-size="10" />
  </ScreenPanel>
</ScreenDemo>
...
<ScreenDemo wide>
  <ScreenPanel>
    <ScreenPagination v-model:page="page2" :total="1280" :page-size="20" />
  </ScreenPanel>
</ScreenDemo>
