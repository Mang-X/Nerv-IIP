...
<script setup>
import { ScreenDonut } from '@nerv-iip/ui'
...
<ScreenDemo>
  <ScreenDonut :segments="states" :size="132" :thickness="13">
...
```vue
<ScreenDonut :segments="deviceStates" :size="132" :thickness="13">
  <b class="num">62</b>
...
<ScreenDemo>
  <ScreenDonut :segments="load" :legend="false" :size="96">
    <b style="font-size: 19px; font-weight: 800; color: var(--sb-text)">71</b>
  </ScreenDonut>
</ScreenDemo>

```vue
<ScreenDonut :segments="segments" :legend="false" :size="96" />
```
