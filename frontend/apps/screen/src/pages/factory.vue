...
const { data, isStale } = useScreenData<FactoryOverview>(fetchFactoryOverview, {
  intervalMs: 4000,
  initialData: buildFactoryOverview(),
})

const ov = computed(() => data.value ?? buildFactoryOverview())
