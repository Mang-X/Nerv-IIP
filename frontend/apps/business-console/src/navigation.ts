...
export const BUSINESS_DOMAINS: NavDomain[] = [
  ...
  },
  {
    ...
    title: '基础数据',
    icon: BoxesIcon,
    to: { path: '/master-data/skus' },
    requiredPermissions: [...BUSINESS_DOMAIN_PERMISSIONS.masterData],
  },
  {
    id: 'engineering',
    title: '产品工程',
    icon: GitBranchIcon,
    to: { path: '/engineering/production-versions' },
    requiredPermissions: [...BUSINESS_DOMAIN_PERMISSIONS.engineering],
  },
  {
    id: 'planning',
    title: '需求与计划',
    ...
    to: { path: '/planning' },
    requiredPermissions: [...BUSINESS_DOMAIN_PERMISSIONS.planning],
  },
  {
    id: 'mes',
    title: '制造执行',
    icon: FactoryIcon,
    to: { path: '/mes' },
    requiredPermissions: [...BUSINESS_DOMAIN_PERMISSIONS.mes],
  },
  {
    id: 'quality',
    title: '质量管理',
    ...
    requiredPermissions: [...BUSINESS_DOMAIN_PERMISSIONS.quality],
  },
  {
    id: 'inventory',
    title: '库存管理',
    ...
    requiredPermissions: [...BUSINESS_DOMAIN_PERMISSIONS.inventory],
  },
  {
    id: 'wms',
    title: '仓储作业',
    icon: WarehouseIcon,
    to: { path: '/wms/inbound' },
    requiredPermissions: [...BUSINESS_DOMAIN_PERMISSIONS.wms],
  },
  {
    id: 'erp',
    title: '经营管理',
    ...
    to: { path: '/erp' },
    requiredPermissions: [...BUSINESS_DOMAIN_PERMISSIONS.erp],
  },
  {
    id: 'barcode',
    title: '条码标签',
    icon: HashIcon,
    to: { path: '/barcode/rules' },
    requiredPermissions: [...BUSINESS_DOMAIN_PERMISSIONS.barcode],
  },
  {
    id: 'equipment',
    title: '设备监控',
    icon: ActivityIcon,
    to: { path: '/equipment' },
    requiredPermissions: [...BUSINESS_DOMAIN_PERMISSIONS.equipment],
  },
  {
    id: 'approval',
    title: '审批中心',
      ...
      items: [
        {
          ...
          icon: PackageIcon,
          to: { path: '/master-data/skus' },
          requiredPermissions: [P.masterDataProductsRead],
        },
        {
          title: '业务伙伴',
          icon: Building2Icon,
          to: { path: '/master-data/partners' },
          requiredPermissions: [P.masterDataResourcesRead],
        },
        {
          title: '工厂结构',
          icon: FactoryIcon,
          to: { path: '/master-data/facilities' },
          requiredPermissions: [P.masterDataResourcesRead],
        },
        {
          title: '设备台账',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          title: '组织与班组',
          icon: UsersRoundIcon,
          to: { path: '/master-data/organization' },
          requiredPermissions: [P.masterDataResourcesRead],
        },
        {
          title: '排班与日历',
          icon: CalendarRangeIcon,
          to: { path: '/master-data/scheduling' },
          requiredPermissions: [P.masterDataResourcesRead],
        },
        {
          title: '技能目录',
          icon: GraduationCapIcon,
          to: { path: '/master-data/skill-catalog' },
          requiredPermissions: [P.masterDataResourcesRead],
        },
        {
          title: '人员技能',
          icon: AwardIcon,
          to: { path: '/master-data/skills' },
          requiredPermissions: [P.masterDataResourcesRead],
        },
      ],
    },
      ...
      items: [
        {
          title: '产品分类',
          icon: FolderTreeIcon,
          to: { path: '/master-data/product-categories' },
          requiredPermissions: [P.masterDataProductsRead],
        },
        {
          title: '计量单位',
          icon: RulerIcon,
          to: { path: '/master-data/units' },
          requiredPermissions: [P.masterDataProductsRead],
        },
        {
          title: '数据字典',
          icon: BookMarkedIcon,
          to: { path: '/master-data/reference-data' },
          requiredPermissions: [P.masterDataResourcesRead],
        },
        {
          title: '编码规则',
          icon: HashIcon,
          to: { path: '/master-data/code-rules' },
          requiredPermissions: [P.masterDataResourcesRead],
        },
      ],
    },
      ...
      items: [
        {
          title: '工程物料',
          icon: BoxIcon,
          to: { path: '/engineering/items' },
          requiredPermissions: [P.engineeringItemsRead],
        },
        {
          title: '设计 BOM',
          icon: NetworkIcon,
          to: { path: '/engineering/ebom' },
          requiredPermissions: [P.engineeringBomsRead],
        },
        {
          title: '制造 BOM',
          icon: GitForkIcon,
          to: { path: '/engineering/mbom' },
          requiredPermissions: [P.engineeringBomsRead],
        },
        {
          title: 'BOM 分析',
          icon: FolderTreeIcon,
          to: { path: '/engineering/bom-analysis' },
          requiredPermissions: [P.engineeringBomsRead],
        },
      ],
    },
      ...
      items: [
        {
          title: '标准工序',
          icon: WrenchIcon,
          to: { path: '/engineering/standard-operations' },
          requiredPermissions: [P.engineeringStandardOperationsRead],
        },
        {
          title: '工艺路线',
          icon: RouteIcon,
          to: { path: '/engineering/routings' },
          requiredPermissions: [P.engineeringRoutingsRead],
        },
        {
          title: '生产版本',
          icon: LayersIcon,
          to: { path: '/engineering/production-versions' },
          requiredPermissions: [P.engineeringProductionVersionsRead],
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          to: { path: '/engineering/eco' },
          requiredPermissions: [P.engineeringChangesRead],
        },
        {
          title: '工程文档',
          icon: FileTextIcon,
          to: { path: '/engineering/documents' },
          requiredPermissions: [P.engineeringDocumentsRead],
        },
      ],
    },
  ],
  planning: [
    {
      items: [
        ...
        },
        {
          ...
          to: { path: '/scheduling' },
          requiredPermissions: [P.schedulingPlansRead],
        },
      ],
    },
  ],
      ...
      items: [
        {
          ...
          to: { path: '/erp' },
          requiredPermissions: [P.erpProcurementRead],
        },
        {
          title: '询价 RFQ',
          icon: SearchIcon,
          to: { path: '/erp/procurement/rfqs' },
          requiredPermissions: [P.erpProcurementRead],
        },
        {
          title: '供应商报价',
          icon: ReceiptTextIcon,
          to: { path: '/erp/procurement/supplier-quotations' },
          requiredPermissions: [P.erpProcurementRead],
        },
        {
          title: '采购订单',
          icon: PackageCheckIcon,
          to: { path: '/erp/procurement/purchase-orders' },
          requiredPermissions: [P.erpProcurementRead],
        },
        {
          title: '采购收货',
          icon: PackageIcon,
          to: { path: '/erp/procurement/receipts' },
          requiredPermissions: [P.erpProcurementRead],
        },
      ],
    },
      ...
      items: [
        {
          ...
          icon: HandshakeIcon,
          to: { path: '/erp/sales' },
          requiredPermissions: [P.erpSalesRead],
        },
        {
          title: '销售报价',
          icon: FileTextIcon,
          to: { path: '/erp/sales/quotations' },
          requiredPermissions: [P.erpSalesRead],
        },
        {
          title: '销售订单',
          icon: ReceiptTextIcon,
          to: { path: '/erp/sales/orders' },
          requiredPermissions: [P.erpSalesRead],
        },
        {
          title: '销售发货',
          icon: PackageCheckIcon,
          to: { path: '/erp/sales/deliveries' },
          requiredPermissions: [P.erpSalesRead],
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          to: { path: '/erp/finance/ar-ap' },
          requiredPermissions: [P.erpFinanceRead],
        },
        {
          title: '会计凭证',
          icon: FileCheck2Icon,
          to: { path: '/erp/finance/vouchers' },
          requiredPermissions: [P.erpFinanceRead],
        },
        {
          title: '成本候选',
        ...
        },
        {
          title: '工作中心费率',
          icon: CoinsIcon,
          to: { path: '/erp/finance/work-center-cost-rates' },
          requiredPermissions: [P.erpFinanceRead],
        },
      ],
    },
      ...
      items: [
        {
          ...
          icon: GaugeIcon,
          to: { path: '/mes' },
          requiredPermissions: [P.mesOverviewRead],
        },
        {
          title: '生产计划',
          icon: CalendarRangeIcon,
          to: { path: '/mes/plans' },
          requiredPermissions: [P.mesPlansRead],
        },
        {
          title: '工单与派工',
          icon: ClipboardListIcon,
          to: { path: '/mes/work-orders' },
          requiredPermissions: [P.mesWorkOrdersRead],
        },
        {
          title: '派工看板',
          icon: UserCheckIcon,
          to: { path: '/mes/dispatch' },
          requiredPermissions: [P.mesDispatchRead],
        },
      ],
    },
    {
      ...
      items: [
        {
          title: '领料与齐套',
          icon: PackageIcon,
          to: { path: '/mes/materials' },
          requiredPermissions: [P.mesMaterialsRead],
        },
        {
          title: '工序执行',
          icon: PlayIcon,
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          requiredPermissions: [P.mesReceiptsRead],
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          to: { path: '/mes/quality' },
          requiredPermissions: [P.mesQualityRead],
        },
        {
          title: '设备与停机',
          icon: WrenchIcon,
          to: { path: '/mes/downtime' },
          requiredPermissions: [P.mesDowntimeRead],
        },
        {
          title: '异常与产能',
          icon: TrendingUpIcon,
        ...
        },
        {
          title: '班次交接',
          icon: ArrowRightLeftIcon,
          to: { path: '/mes/handovers' },
          requiredPermissions: [P.mesHandoversRead],
        },
      ],
    },
    {
      ...
      items: [
        {
          title: '追溯查询',
          icon: SearchIcon,
          to: { path: '/mes/traceability' },
          requiredPermissions: [P.mesTraceabilityRead],
        },
        {
          title: '生产准备检查',
          icon: CheckCheckIcon,
          to: { path: '/mes/foundation' },
          requiredPermissions: [P.mesFoundationRead],
        },
      ],
    },
  ],
  quality: [
    {
      items: [
        ...
        },
        {
          title: '不合格品处理',
          icon: ShieldAlertIcon,
          to: { path: '/quality/ncrs' },
          requiredPermissions: [P.qualityNcrRead],
        },
        {
          title: '质量分析',
          icon: LineChartIcon,
          to: { path: '/quality/analysis' },
          requiredPermissions: [P.qualityNcrRead],
        },
        {
          title: '计量与校准',
        ...
        },
        {
          ...
          requiredPermissions: [P.qualityNcrManage],
        },
      ],
    },
  ],
      ...
      items: [
        {
          ...
          icon: PackageSearchIcon,
          to: { path: '/inventory/availability' },
          requiredPermissions: [P.inventoryLedgerRead],
        },
        {
          title: '批次与预留',
          icon: LayersIcon,
          to: { path: '/inventory/lots' },
          requiredPermissions: [P.inventoryLedgerRead],
        },
        {
          title: '库存移动',
          ...
          requiredPermissions: [P.inventoryMovementsCreate],
        },
        {
          title: '库存盘点',
          icon: ClipboardListIcon,
          to: { path: '/inventory/counts' },
          requiredPermissions: [P.inventoryCountsManage],
        },
        {
          title: '库位',
          icon: MapPinIcon,
          to: { path: '/inventory/locations' },
          requiredPermissions: [P.inventoryLocationsManage],
        },
      ],
    },
  ],
  wms: [
    {
      items: [
        ...
        },
        {
          ...
          requiredPermissions: [P.wmsShipmentsRead],
        },
        {
          title: '拣货任务',
          icon: PackageSearchIcon,
        ...
        },
        {
          ...
          icon: CpuIcon,
          to: { path: '/wms/wcs' },
          requiredPermissions: [P.wmsAutomationManage],
        },
        {
          title: '盘点执行',
          icon: ClipboardCheckIcon,
  ...
  equipment: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          requiredPermissions: [P.iiotAlarmsRead, P.iiotAlarmRulesManage],
        },
        {
          title: '历史趋势',
          icon: LineChartIcon,
          to: { path: '/equipment/telemetry/history' },
          requiredPermissions: [P.iiotTelemetryRead],
        },
        {
          title: 'OEE 趋势与横比',
        ...
        },
        {
          title: '设备控制通道绑定',
          icon: CpuIcon,
          to: { path: '/equipment/telemetry/control-bindings' },
          requiredPermissions: [P.iiotDeviceControlRead],
        },
      ],
    },
    {
      ...
      items: [
        {
          title: '维护工单',
          icon: WrenchIcon,
          to: { path: '/maintenance/work-orders' },
          requiredPermissions: [P.maintenanceWorkOrdersRead],
        },
        {
          title: '保养计划',
          icon: CalendarClockIcon,
          to: { path: '/maintenance/plans' },
          requiredPermissions: [P.maintenancePlansRead],
        },
        {
          title: '点检记录',
          icon: ClipboardCheckIcon,
          to: { path: '/maintenance/inspections' },
          requiredPermissions: [P.maintenancePlansRead],
        },
        {
          title: '备件需求',
        ...
        },
        {
          title: '可靠性指标',
          icon: TrendingUpIcon,
          to: { path: '/maintenance/reliability' },
          requiredPermissions: [P.maintenanceWorkOrdersRead],
        },
        {
          title: '可用窗口',
          icon: CalendarRangeIcon,
          to: { path: '/maintenance/availability' },
          requiredPermissions: [P.maintenanceWorkOrdersRead],
        },
      ],
    },
