...
.ds-mswitch-thumb {
  /* Tailwind v4 glides the thumb via the `translate` property — name it in the
     transition (a `transform`-only transition never fires). Slight back-ease
     spring for the native iOS feel. */
  transition: translate 0.26s var(--ease-out-back, cubic-bezier(0.34, 1.4, 0.64, 1));
}
