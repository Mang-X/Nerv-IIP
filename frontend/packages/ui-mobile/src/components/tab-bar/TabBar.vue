...
<template>
  <nav data-slot="tab-bar" :class="cn('flex items-stretch', props.class)">
    <button
      ...
      class="nv-m-tabbar-btn min-h-touch flex flex-1 flex-col items-center justify-center gap-0.5 py-1.5 text-xs"
    ...
    >
      ...
      <span class="nv-m-tabbar-hit" aria-hidden="true" />
...
@layer nv-components {
  ...
  .nv-m-tabbar-btn:active .nv-m-tabbar-hit {
    opacity: 1;
