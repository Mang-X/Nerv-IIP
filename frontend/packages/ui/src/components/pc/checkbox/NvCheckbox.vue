...
@layer nv-components {
  ...
  .nv-check:active:not([data-disabled]) {
    transform: scale(0.88);
  }
  .nv-check-ind {
    animation: nv-check-in 0.18s var(--nv-ease-out-quart, ease-out);
  }
  @keyframes nv-check-in {
    from {
      opacity: 0;
      transform: scale(0.6);
    }
