 ...
 * when it lags). Numbers render tabular-nums. Composes NvCard, never edits原版.
 */
...
<template>
  <NvCard :class="cn('p-5', props.class)" data-slot="nv-metric-comparison">
    ...
    <div class="mt-4">
      ...
      <div class="mt-1.5 h-1.5 w-full overflow-hidden rounded-full bg-muted">
        <div
          :class="cn('nv-mc-bar h-full rounded-full', barTone)"
          :style="{ width: `${barPct}%` }"
        />
      </div>
    </div>
