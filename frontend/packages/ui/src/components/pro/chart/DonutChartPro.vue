...
const segmentTooltip = (d: { data?: DonutSlice; index?: number } | DonutSlice) => {
  ...
  return `<div class="ds-vis-card"><div class="ds-vis-row"><span class="ds-vis-dot" style="background:${sliceColor(
    slice,
    i,
...
<template>
  <div :class="cn('ds-donut flex items-center gap-6', props.class)">
