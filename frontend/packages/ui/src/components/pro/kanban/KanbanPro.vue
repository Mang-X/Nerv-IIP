...
/** Tone for a column header — maps onto BadgePro tonal variants. */
 ...
 * slot so consumers render their own cards (e.g. RecordCardPro). Drag is out of
  ...
  >
    ...
    >
      <header class="flex items-center justify-between gap-2">
        ...
        <BadgePro :variant="column.tone ?? 'neutral'" class="tabular-nums">
          {{ column.items.length }}
        </BadgePro>
      </header>
