...
import AreaChartPro from '../chart/AreaChartPro.vue'
 ...
 * AreaChartPro), so in-card trends share the same engine as full charts and
...
<template>
  <CardPro :class="cn('overflow-hidden p-5', props.class)">
    ...
    <AreaChartPro v-if="chartData.length > 1" minimal :data="chartData" :height="46" class="mt-4" />
