...
<template>
  <span
    :class="
      cn('ds-dot relative inline-flex shrink-0', size === 'sm' ? 'size-1.5' : 'size-2', props.class)
    "
    :style="{ '--dot': toneVar }"
  >
    <span v-if="pulse" class="ds-dot-ping absolute inset-0 rounded-full" aria-hidden="true" />
