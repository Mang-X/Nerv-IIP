 ...
 * popover (no @internationalized/date dep), ButtonPro trigger, brand selection,
 * today ring. String model, consistent with TimePickerPro.
 */
    ...
    <PopoverContent class="w-auto p-3" align="start">
      ...
      <div class="grid grid-cols-7 gap-0.5">
        ...
        <button
          ...
          :class="
            cn(
              'ds-dp-cell grid size-8 place-items-center rounded-md text-sm tabular-nums transition-colors',
      ...
      <div class="mt-2 border-t border-border pt-2">
        <ButtonPro variant="ghost" size="sm" class="w-full" @click="pickToday">今天</ButtonPro>
      </div>
    </PopoverContent>
  </Popover>
</template>
