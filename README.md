...
- 当前能力基线：已完成 IAM Persistent Auth Foundation、Gateway-wide permission enforcement、Console Auth + shadcn-vue 基线、Phase 8 IAM Admin Console、FileStorage MVP、本地 tus hardening、业务平台 Wave 1/2/2.5/3、BusinessGateway/BusinessConsole MVP、事件可靠性基线、ExternalClient client_credentials、生产安全硬化、生产部署产物、opt-in 发布演练和性能阈值化基线。
