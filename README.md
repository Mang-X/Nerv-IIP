...
- 当前开发分支：`codex/phase-8-iam-admin-design-system-spec` 已完成 IAM Persistent Auth Foundation、Gateway-wide permission enforcement、pnpm 11.1.2 基线、Console Auth + shadcn-vue 基线、Phase 8 蓝色 Design System baseline 和 IAM Admin Console workflow。
