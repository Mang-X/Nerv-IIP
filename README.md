...
业务平台当前已完成 Wave 1、Wave 2、Equipment Reliability 和 Wave 3 ERP 接入：BusinessMasterData、ProductEngineering、Inventory、Quality、MES、DemandPlanning、BarcodeLabel、BusinessApproval、WMS、IndustrialTelemetry、Maintenance 和 ERP 均已有服务代码、AppHost 注册和对应 verify 脚本。后续主线进入 #77 Full-chain acceptance。
...
8. 业务平台 ERP Wave 3 已完成 Procurement、Sales、Finance 和注册/验证收口；下一主线是 #77 Full-chain acceptance。规划入口见 `docs/superpowers/specs/2026-05-23-business-full-chain-acceptance-design.md`。
