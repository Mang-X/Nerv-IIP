...
# #2944 的维护可用窗口求交谓词验收类同样只含真实 PostgreSQL 用例，总数为 88。
# #3650 的 MES 安灯聚合持久化证明类整类交给 postgres lane，总数为 89。
Assert-Contract ($excludedSelectors.Count -eq 89) '所有已排除的真实依赖测试选择器必须显式分类。'
