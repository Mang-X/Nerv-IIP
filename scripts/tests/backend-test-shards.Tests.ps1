...
# provider 类同样只含真实 PostgreSQL 用例，因此当前选择器总数为 72。
Assert-Contract ($excludedSelectors.Count -eq 72) 'Every currently excluded real-dependency test selector must be explicitly classified.'
