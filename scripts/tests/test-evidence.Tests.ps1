...
# #2813 注册 NCR 返工成本 FullChain，增至 51。
Assert-Equal 51 $liveAssignments.Count 'The approved initial source skip inventory changed; classify the diff explicitly.'
...
Assert-Equal 50 @($mesProductionCandidateRules[0].testIdentities).Count 'The MES production candidate policy rule must freeze its fifty governed PostgreSQL identities.'
