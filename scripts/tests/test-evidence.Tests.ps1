...
Assert-Equal 40 @($mesProductionCandidateRules[0].testIdentities).Count 'The MES production candidate policy rule must freeze its forty governed PostgreSQL identities.'
