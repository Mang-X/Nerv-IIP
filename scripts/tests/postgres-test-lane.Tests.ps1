...
try {
    ...
    # Quality 同理：六个类中只有 13 条是真实 PostgreSQL 证明。
    ...
    Assert-Contract (@($qualityMember.expectedTestIdentities).Count -eq 13) 'The Quality member must freeze exactly its thirteen governed PostgreSQL identities.'
