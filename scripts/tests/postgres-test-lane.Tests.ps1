...
try {
    ...
    # Quality 同理：六个类中只有 17 条是真实 PostgreSQL 证明。
    ...
    Assert-Contract (@($qualityMember.expectedTestIdentities).Count -eq 17) 'The Quality member must freeze exactly its seventeen governed PostgreSQL identities.'
