...
try {
    ...
    $smallServiceMembers = @(
        @{ id = 'barcodelabel-postgres-profile'; service = 'BarcodeLabel'; schema = 'barcode'; identities = @(
                ...
                'Nerv.IIP.Business.BarcodeLabel.Web.Tests.BarcodeLabelPostgresProfileTests.Print_item_serial_is_unique_inside_organization_environment_and_rule_on_postgres',
                ...
                'Nerv.IIP.Business.BarcodeLabel.Web.Tests.BarcodeLabelPostgresProfileTests.Serial_counter_restricts_rule_deletion_after_allocation_on_postgres',
