...
try {
    ...
    # 和 NCR 返工工单 5 条来源、幂等、并发与范围隔离证明，共有 45 条真实 PostgreSQL 证明；
    ...
    Assert-Contract (@($mesMember.expectedTestIdentities).Count -eq 45) 'The MES member must freeze exactly its forty-five governed PostgreSQL identities.'
