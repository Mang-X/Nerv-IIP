...
try {
    ...
    # Quality 同理：六个类中只有 16 条是真实 PostgreSQL 证明。
    ...
    Assert-Contract (@($qualityMember.expectedTestIdentities).Count -eq 16) 'The Quality member must freeze exactly its sixteen governed PostgreSQL identities.'
