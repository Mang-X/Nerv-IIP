...
try {
    ...
    # Quality 同理：六个类共 23 条用例，只有 10 条是真实 PostgreSQL 证明。
    ...
    Assert-Contract (@($qualityMember.expectedTestIdentities).Count -eq 10) 'The Quality member must freeze exactly its ten governed PostgreSQL identities.'
