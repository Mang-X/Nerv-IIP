...
Assert-Contract ($content.Contains('Redis_cap_retry_converges_changed_v2_after_first_consumer_failure')) 'Verify script must execute the real Redis first-attempt-failure retry test.'
