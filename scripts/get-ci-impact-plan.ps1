...
if (-not [string]::IsNullOrWhiteSpace($StepSummaryPath)) {
    ...
    [void]$summary.AppendLine('NERV-668 routes Backend Tests, Connector Host Tests, Script Governance, and OpenAPI/api-client Drift; NERV-688 routes PostgreSQL Provider Tests and Redis/CAP Transport Tests; NERV-685 derives governed frontend workspace shards.')
    [void]$summary.AppendLine()
