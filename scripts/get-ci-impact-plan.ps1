...
if (-not [string]::IsNullOrWhiteSpace($StepSummaryPath)) {
    ...
    [void]$summary.AppendLine('NERV-668 routes Connector Host Tests, Script Governance, and OpenAPI/api-client Drift; NERV-685 derives governed frontend workspace shards. ERP acceptance and Backend Tests remain unrouted.')
    [void]$summary.AppendLine()
