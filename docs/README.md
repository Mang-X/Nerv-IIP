...
| 查询 Schema、码表、矩阵、术语或技术资料 | [`reference/README.md`](reference/README.md) | Reference 只做人工索引；精确事实回到 producer |
...
| Reference | 当前有哪些字段、Schema、路由、矩阵、码表、术语和资料入口？ | 随真正 producer 更新；人工解释不得覆盖 producer |
...
3. Reference 中的 Schema、码表、矩阵和技术资料必须标明 producer；与 producer 冲突时修正文档，不另建平行真相源。
