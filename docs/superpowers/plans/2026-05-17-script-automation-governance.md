...
Completion note: `scripts/check-script-compatibility.ps1` records compatibility evidence under `artifacts/script-logs/script-compatibility/**/evidence.json`; the first full Ubuntu WSL evidence was recorded at `artifacts/script-logs/script-compatibility/20260517-233939-907/evidence.json`. The fourth/fifth verify scripts have had their priority baseline exemptions removed. Remaining legacy scripts are tracked as follow-on migration work, not blockers for the next feature stage.
