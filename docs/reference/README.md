...
| [`frontend/navigation-map.md`](frontend/navigation-map.md) | Console / Business Console / Business PDA router、navigation/permission producer、AppShell、Gateway OpenAPI | producer 路径或职责变化时同步索引；不复制 route、端口或交付状态清单 | 前端 IA 实现、导航/RBAC/Gateway 审查 | 人工索引；精确事实回到 producer |
