...
| Quality | `backend/services/Business/Quality` | `quality` | 检验标准、检验计划、检验记录、不合格处置 | 库存余额、仓储作业状态、采购销售单据 | MasterData、Inventory、File Storage |
...
| Quality | `quality.InspectionPassed`、`quality.InspectionRejected`、`quality.NonconformanceDispositionCompleted` | WMS、MES、ERP、Inventory | 质检与不合格处置结果。 |
