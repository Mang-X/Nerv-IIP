...
Inventory 的 3 个；MasterData 的 5 个；Scheduling 的 6 个；AppHub 3 个；BarcodeLabel/FileStorage/Maintenance 各 1 个；IndustrialTelemetry 15 个；Quality 24 个；MES 47 个；WMS 9 个；ERP 15 个；DemandPlanning 3 个；跨业务 Acceptance 3 个。
