...
| BusinessPartner | partnerCode, name, partnerRoles, status, taxId, taxRegionCode, defaultCurrencyCode, paymentTermsCode, primaryAddress, primaryContactName, primaryContactEmail, primaryContactPhone, complianceTags, disabled | ERP Procurement/Sales/Finance, WMS, Quality, Planning | RFQ, quotation, purchase order, sales order, AR/AP, supplier scorecard transactions |
