...
| MinIO | Frozen object-storage baseline; local runtime image uses `pgsty/minio:RELEASE.2026-04-17T00-00-00Z`, while FileStorage continues to depend on the provider abstraction for MinIO or equivalent S3-compatible backends. | [MinIO docs](https://min.io/docs/minio/linux/index.html) | [pgsty/minio image](https://hub.docker.com/r/pgsty/minio) |
