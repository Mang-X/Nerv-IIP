...
28. 业务平台 GitHub issue roadmap 已完成重整并进入收口态：#70/#71、#127 到 #141、#143、#166 到 #175 均已关闭；截至 2026-05-26，#77 P0 full-chain acceptance 已完成收口，open 项只剩 #78 和 #142。#142 是 post-MVP MinIO/S3 multipart，#78 是甘特/RFC 参考。
