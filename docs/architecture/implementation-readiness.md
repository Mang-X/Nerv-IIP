...
28. 业务平台 GitHub issue roadmap 已完成重整并进入收口态：#70/#71、#127 到 #141、#143、#166 到 #175 均已关闭；截至 2026-05-25，#77 已进入 P0 收口 PR，合并后 open 项只剩 #78 和 #142。#142 是 post-MVP MinIO/S3 multipart，#78 是甘特/RFC 参考。
...
31. 运行 `dotnet test backend/tests/Nerv.IIP.Messaging.CAP.Tests/Nerv.IIP.Messaging.CAP.Tests.csproj --no-restore` 可验证 #170 当前已纳入的 consumer guard、envelope 版本校验和 in-memory DLQ/replay store 行为。
