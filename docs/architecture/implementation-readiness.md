...
28. 业务平台 GitHub issue roadmap 已完成重整：#70、#71、#73、#74、#75、#76 和 #77 保留为事实对齐后的 epic，新增 #131 到 #143 作为可执行子 issue；#72 维持已关闭状态，#78 已归档为 `docs/architecture/gantt-scheduling-visualization-rfc.md`，且只交付 mock-only 前端组件包 foundation，不进入本轮后端、领域服务或 Console MVP 实施路线图。
