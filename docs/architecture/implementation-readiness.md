...
| #131 Inventory / #412 Inventory business gap | `docs/superpowers/specs/2026-05-23-inventory-mvp-design.md`、`docs/superpowers/plans/2026-05-23-inventory-mvp.md`、`docs/superpowers/specs/2026-06-15-inventory-business-gap-design.md`、`docs/superpowers/plans/2026-06-15-inventory-business-gap.md` | 已完成库存事实源服务，覆盖库存地点、受控库存状态、台账、预留/分配、移动平均计价、移动、盘点冻结/复盘保护和 Quality inspection result 到库存状态转移的窄闭环，并接入 solution/AppHost/verify/readiness。 |
