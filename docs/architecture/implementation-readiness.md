...
5. Notification 的偏好/订阅、外部通道 provider、限流、模板映射（由 #728 承接）和 DLQ replay 管理入口；边界口径应遵守 docs/architecture/notification-baseline.md。
