...
- 尚未交付但已纳入本批执行入口：#683 OPC UA 采集连接器、#684 Modbus TCP/MQTT 采集连接器、#685 AlarmRaised/AlarmCleared 接入 Notification、#686 报警 ack/shelve/escalation、#687 设备控制命令下发、#688 IndustrialTelemetry 侧运行小时聚合与持久累计、#689 historian raw/hourly/daily 分层存储、#690 DeviceStateChanged 下游消费。
