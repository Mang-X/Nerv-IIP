...
28. 业务平台 GitHub issue roadmap 已完成阶段性重整：#70/#71、#127 到 #141、#143、#166 到 #175 均已关闭；#77 已完成 P0 full-chain acceptance 收口。2026-05-27 起，MES operational foundation reset 以 #188 到 #207 作为新的 P0 执行入口；#142 仍是 post-MVP MinIO/S3 multipart，#78 仍是甘特/RFC 前端参考，#206 负责 APS 调度内核与排程数据契约，#207 负责设备 IIoT/IndustrialTelemetry 运行事实与 APS/MES 联动。
