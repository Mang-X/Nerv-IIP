...
- M4 后 `docs/architecture/*-module-product-design.md`、`docs/architecture/frontend-navigation-map.md` 等旧平铺路径已退出；当前 Product 链接只指向本目录或其它 canonical owner，历史旧路径通过冻结材料和 Git 追溯。
