...
Nerv-IIP 后端需要同时承载身份与权限、应用目录与实例发现、运维编排、AI 工具治理、知识检索以及前端聚合接口。0 到 1 阶段既不能把所有平台能力压成单体，也不能过早兑现成完全独立部署的高运维成本微服务群。
...
2. 逻辑边界固定为 IAM、AppHub、Ops、AI Integration、Knowledge、Gateway/BFF、Agent Host 七类能力。
...
1. 首批脚手架至少落下 PlatformGateway、Iam、AppHub、Ops 四个最小服务骨架，以及 common/Observability、common/Contracts、common/Testing 三个窄共享库。
